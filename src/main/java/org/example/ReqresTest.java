...
public class ReqresTest {
    ...
    public void SuccessfullyRegisteredTest() {
        ...
        SeccessRegister seccessRegister = given()
                .body(user)
                .when()
                .post("api/register")
                .then().log().all()
                .extract().as(SeccessRegister.class);
        Assert.assertEquals(id,seccessRegister.getId());
        Assert.assertEquals(token,seccessRegister.getToken());
    }
    @Test
    ...
    public void timeTest() {
        ...
        Assert.assertEquals(Clock.systemUTC(),response);
